...
<div class="mylist">
    <div class="row mx-auto">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 mr-0 pr-0  mx-auto">
          <a href="{{route('sale.details',[$slug])}}"><h6 class="fscolor">{{$name}}</h6></a>
      ...
      <div class="row mx-auto">
        <div class="col-sm-4 col-md-4 col-lg-4 col-xs-4 mr-0 pr-0 mx-auto mt-2 ">
          <a href="{{route('sale.details',[$slug])}}">
            <img alt="" src="{{ $logo }}" class="border img-fluid img-responsive">
            
          </a>
        </div>
        <div class="col-sm-8 col-md-8 col-lg-8 col-xs-8 mt-3">
          <h6 class=" text-justify"><strong>Products Detail:</strong></h6>
                  <label>{{$product_detail}}</label>
        </div>
      </div>
      <div class="row mx-auto mt-2 mb-">
        <div class="col-sm-12 col-md-12 col-lg-12  mr-0 pr-0  text-justify">
      ...
      <div class="row  mb-2 mx-auto border">
        <div class="col-sm-8 col-md-8 col-lg-8 col-xs-8 mx-auto border-right">
          <h6 class="mt-2 ">
              <br>
        ...
        <div class="col-sm-4 col-md-4 col-lg-4  mx-auto">
          <a roll="button" class="btn blue-btn mt-3" href="{{route('sale.details',[$slug])}}">
          View more</a>
