                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item contacttab col-lg-3 col-md-3 col-sm-3 col-12 active ">
                            <a class="contacttab-link contacttab " id="contact-tab" data-toggle="tab" href="#contact"
                    ...
                    <div class="tab-content h-100 tab-brk" id="myTabContent">
                        ...
                        <!-- ***********Distributors Search*********** -->
                        <div class="tab-pane fade show active contacttab pt-4 pb-4" id="contact" role="tabpanel"
                ...
                <div class="row">
                    <div class="col-md-12 rounded-0 bg-light py-4 px-3">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <label class="border bscolor bg-white rounded-0 form-control h-75 py-2 px-2"><span
                                        class="fscolor">Brand Name:</span> <br>
                                    <h6>{{ $listing->brand }}</h6>
                                </label>
                            ...
                            <div class="col-md-4">
                                <label class="border bscolor bg-white rounded-0 form-control h-75 py-2 px-2"><span
                                        class="fscolor">City:</span> <br>
                                    <h6>{{ $listing->cities_needed }}</h6>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-9 col-md-12 col-12 ">
                <section
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top border-bottom">
                            <label class="mt-2">{{ $listing->business_profile }}</label>
                        </div>
                    </div>
                </section>
                <br>
                <section
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top border-bottom">
                            <label class="mt-2">{{ $listing->product_detail }}</label>
                        </div>
                    </div>
                </section>
                <br>
                <section
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-light border-top">
                            <h5 class="mt-2"><strong>Target Customers</strong></h5>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top border-bottom">
                            <label class="mt-2">{{ $listing->target_customer }}</label>
                        </div>
                    </div>
                </section>
                <br>
                <section
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-light border-top">
                            <h5 class="mt-2"><strong>Expected Work</strong></h5>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top border-bottom">
                            <label class="mt-2">{{ $listing->expected_work }}</label>
                        </div>
                    </div>
                </section>
                <br>
                <section
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-light border-top">
                            <h5 class="mt-2"><strong>Targeted Cities</strong></h5>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top border-bottom">
                            <label class="mt-2">{{ $listing->cities_needed }}</label>
                        </div>
                    </div>
                </section>
                <br>
                ...
                <section
                    class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border border-top-0  border-bottom-0 border-width:medium;">
                    @php 
                    $state = Helper::location($listing->state_id, 'state');
                    ...
                    @forelse($relatedCats as $l)
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                            <div class="border h-100 p-3 text-center">
                                ...
                                <div class="pdetail">
                                    <h5><a href="{{ url('salesagent') }}/{{ $l->slug }}"
                                            class="text-primary">{{ $l->name }}</a></h5>
                                    <p>Location</p>
                                    @php 
                                    $location = Helper::location($l->state_id,'state');
                                     $location2 = Helper::location($l->country_id,'country');
                                      @endphp
                                    <p>  {{$location}}{{!empty($location2)?(!empty($location)?" , ":"").$location2:""}}       
