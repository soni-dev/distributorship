                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item hometab col-lg-3 col-md-3 col-sm-3 col-12 active ">
                            <a class="hometab-link hometab " id="home-tab" data-toggle="tab" href="#home" role="tab"
                                aria-controls="home">
                    ...
                    <div class="tab-content h-100 tab-brk" id="myTabContent">
                        ...
                        <!-- ***********Distributors Search*********** -->
                        <div class="tab-pane fade show active hometab pt-4 pb-4" id="home" role="tabpanel"
                ...
                <div class="row">
                    <div class="col-md-12 rounded-0 bg-light py-4 px-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <label class="border bscolor bg-white rounded-0 form-control h-75 py-2 px-2"><span
                                    ...
                                    <h6>Rs. {{ $listing->anualsale_start }}{{ $listing->anualsale_unit }} - Rs.
                                        {{ $listing->anualsale_end }}{{ $listing->anualsale_unit }}</h6>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label class="border bscolor bg-white rounded-0 form-control h-75 py-2 px-2"><span
                                        class="fscolor">Annual Sale:</span> <br>
                                    <h6>Rs. {{ $listing->anualsale_start }} - Rs. {{ $listing->anualsale_end }}
                                        {{ $listing->anualsale_unit }}</h6>
        ...
        <div class="row h-100">
            <div class="col-lg-9 col-md-12 col-12 ">
                ...
                <section
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-6 col-sm-6 col-6  border-top border-left border-bottom">
                            <label class="mt-2">Rs. {{ $listing->anualsale_start }}{{ $listing->anualsale_unit }} - Rs.
                                {{ $listing->anualsale_end }}{{ $listing->anualsale_unit }}</label>
                        </div>
                    </div>
                </section>
                <br>
                <section
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top bg-light">
                            <h5 class="mt-2"><strong>Distributorship Level</strong></h5>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top border-bottom">
                            <label class="mt-2">{{ $type_distributorship }} </label>
                        </div>
                    </div>
                </section>
                <br>
                    ...
                    @forelse($relatedCats as $l)
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                            <div class="border h-100 p-3 text-center">
                                ...
                                <div class="pdetail">
                                    <h5><a href="{{ url('distributor') }}/{{ $l->slug }}"
                                            class="text-primary">{{ $l->name }}</a></h5>
                                    <p>Investment required</p>
                                    <p>Rs. {{ $l->anualsale_start }}{{ $l->anualsale_unit }} - Rs.
                                        {{ $l->anualsale_end }}{{ $l->anualsale_unit }}</p>
