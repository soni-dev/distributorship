    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                {{-- distributionship lists --}}
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="fa-solid fa-list"></i>
                        <span>Distributionship</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('dists.list','distributor') }}">Distributor List</a></li>
                        <li><a href="{{ route('dists.list','frenchies') }}">Frenchies List</a></li>
                        <li><a href="{{ route('dists.list','sales') }}">Sales Agent List</a></li>
                    </ul>
                </li>
